...
cog_user_pool_id=$(aws ssm get-parameter --name '/samplesheet-check/fe/react/REACT_APP_COG_USER_POOL_ID' | jq -r .Parameter.Value)
...
cog_identity_pool_id=$(aws ssm get-parameter --name '/samplesheet-check/fe/react/REACT_APP_COG_IDENTITY_POOL_ID' | jq -r .Parameter.Value)
cog_app_client_id_local=$(aws ssm get-parameter --name '/samplesheet-check/fe/react/REACT_APP_COG_APP_CLIENT_ID_LOCAL' | jq -r .Parameter.Value)
cog_app_client_id_stage=$(aws ssm get-parameter --name '/samplesheet-check/fe/react/REACT_APP_COG_APP_CLIENT_ID_STAGE' | jq -r .Parameter.Value)

oauth_domain=$(aws ssm get-parameter --name '/samplesheet-check/fe/react/REACT_APP_OAUTH_DOMAIN' | jq -r .Parameter.Value)
oauth_redirect_in_local=$(aws ssm get-parameter --name '/samplesheet-check/fe/react/REACT_APP_OAUTH_REDIRECT_IN_LOCAL' | jq -r .Parameter.Value)
oauth_redirect_out_local=$(aws ssm get-parameter --name '/samplesheet-check/fe/react/REACT_APP_OAUTH_REDIRECT_OUT_LOCAL' | jq -r .Parameter.Value)
oauth_redirect_in_stage=$(aws ssm get-parameter --name '/samplesheet-check/fe/react/REACT_APP_OAUTH_REDIRECT_IN_STAGE' | jq -r .Parameter.Value)
oauth_redirect_out_stage=$(aws ssm get-parameter --name '/samplesheet-check/fe/react/REACT_APP_OAUTH_REDIRECT_OUT_STAGE' | jq -r .Parameter.Value)

api_url=$(aws ssm get-parameter --name '	/samplesheet-check/be/rest-api' | jq -r .Parameter.Value)
